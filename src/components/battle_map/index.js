...
export default class BattleMap {
  ...
  render() {
    this.renderInitialBattleMap();
    const stage = new Stage(
      this.stage,
      this.layer,
      this.tr,
      this.battleMap,
      document.getElementById("battle-map-container")
    );
    stage.render();
    const terrainMenu = new TerrainMenu(
      document.getElementById("terrain-menu"),
      this.layer
    );
    terrainMenu.render();
  }
